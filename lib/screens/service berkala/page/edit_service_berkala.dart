...
import '../../home/controller/home_mekanik_controller.dart';
import '../../home/controller/home_super_admin_controller.dart';
import '../model/mtc_model.dart';

class EditServiceBerkalaAdmin extends StatefulWidget {
  const EditServiceBerkalaAdmin({super.key, required this.model});

  final MtcModel model;

  @override
  State<EditServiceBerkalaAdmin> createState() =>
      _EditServiceBerkalaAdminState();
}

class _EditServiceBerkalaAdminState extends State<EditServiceBerkalaAdmin> {
...
class EditServiceBerkalaMekanik extends StatefulWidget {
  const EditServiceBerkalaMekanik({super.key, required this.model});

  final MtcModel model;

  @override
  State<EditServiceBerkalaMekanik> createState() =>
      _EditServiceBerkalaMekanikState();
}

class _EditServiceBerkalaMekanikState extends State<EditServiceBerkalaMekanik> {
  late TextEditingController mekanikC;
  late TextEditingController kpoolC;
  late TextEditingController noPolisiC;
  late TextEditingController lastKmServiceC;
  ...
  late HomeMekanikController controller;
  ...
  void initState() {
    ...
    controller = Get.find<HomeMekanikController>();
  }
